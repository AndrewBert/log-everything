...
class OnboardingKeys {
  // CP: Welcome step sign-in section keys
  static const signInWithGoogleButton = ValueKey('signInWithGoogleButton');
  static const signInWithAppleButton = ValueKey('signInWithAppleButton');
